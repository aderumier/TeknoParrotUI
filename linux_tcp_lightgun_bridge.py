#!/usr/bin/env python3
"""TCP linux bridge for Teknoparrot, DemulShooter and BepInEx gun game plugins
...
Supported games: teknoparrot, demul, rha, wws, tra, owr, mib, mia, nha2, marss, pvz, pbx, rgs

Examples:
  %(prog)s --game teknoparrot --gun1 /dev/input/event0
...
def build_ds_packet(states, game, scr_w, scr_h):
    ...
    elif game == 'demul' or game == 'teknoparrot':
